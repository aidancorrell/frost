//! Fixture helpers for frost-mcp integration tests.
//!
//! Creates realistic Iceberg table directories with metadata JSON and Avro
//! manifest files so MCP tool handlers can be tested end-to-end.
...
/// A healthy table with 10 normal-sized files, 1 snapshot — no findings expected.
...
/// A table with 200 tiny files + 10 normal files — triggers small_files finding.
